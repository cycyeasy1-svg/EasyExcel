...
export default class DataProxy {
  constructor(name, settings) {
    ...
    this.zoom = normalizeZoom(this.settings.zoom);
    // save data begin
    ...
    this.rows.setScale(this.zoom);
    this.cols.setScale(this.zoom);
  ...
  setZoom(zoom) {
    ...
    this.zoom = nextZoom;
    this.settings.zoom = nextZoom;
    this.rows.setScale(nextZoom);
    this.cols.setScale(nextZoom);
    this.scroll.x *= ratio;
    this.scroll.y *= ratio;
    return true;
  }
  ...
  getImageDisplayRect(anchor) {
    ...
    if (anchor.width != null && anchor.height != null) {
      width = anchor.width * this.zoom;
      height = anchor.height * this.zoom;
