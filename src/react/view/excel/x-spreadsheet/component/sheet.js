...
function sheetReset() {
  ...
  editor.setZoom(this.data.zoom || 1);
  editor.setRowHeight(this.data.rows.height);
  rowResizer.minDistance = this.data.rows.height;
  colResizer.minDistance = this.data.cols.minWidth;
  tableEl.attr(vRect);
...
export default class Sheet {
  constructor(targetEl, data) {
    ...
    this.editor.setZoom(data.zoom || 1);
    // data validation
